...
export default function GenerateAI() {
  ...
  return (
    <>
      <h1 className="text-6xl font-extrabold text-center mb-10">Generar Receta con IA</h1>
        ...
        >
          <div className="relative">
            <input
              name="prompt"
              id="prompt"
              className="border bg-white p-4 rounded-lg w-full border-slate-800 placeholder:italic"
